...
The shiny app developed for this assignment is avalilable at:(https://mohannadnafee.shinyapps.io/ShinyApp/)  
  
The source codes of ui.R and server.R and also Rpresentation are available on the GitHub repo:
(https://github.com/MohannadNafee/Developing_Data_Products.git)
